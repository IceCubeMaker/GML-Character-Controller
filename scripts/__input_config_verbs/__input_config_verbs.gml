...
return {
    ...
    gamepad:
    {
        ...
        shoot:     input_binding_gamepad_button(gp_shoulderlb),
        
        pause: input_binding_gamepad_button(gp_start),
		consume: input_binding_gamepad_button(gp_face3),
		run: input_binding_gamepad_button(gp_face1),
		dash: input_binding_gamepad_button(gp_face2),
		swap_character: input_binding_gamepad_button(gp_face1),
		drop_item: input_binding_gamepad_button(gp_shoulderrb),
    },
